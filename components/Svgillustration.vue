  ...
  >
    ...
    <defs>
      <linearGradient
        ...
        id="linearGradient-1"
      >
        <stop stop-color="#7F9BFC" offset="0%" />
        <stop stop-color="#839FFC" stop-opacity="0.9563" offset="5.509039%" />
        <stop stop-color="#849FFC" stop-opacity="0.9533" offset="5.884359%" />
        <stop stop-color="#8AA4FC" stop-opacity="0.8154" offset="23.03%" />
        <stop stop-color="#9CB1FD" stop-opacity="0.6239" offset="46.86%" />
        <stop stop-color="#BAC7FD" stop-opacity="0.4019" offset="74.47%" />
        <stop stop-color="#D3DAFE" stop-opacity="0.2445" offset="94.06%" />
        <stop stop-color="#F0F0FF" stop-opacity="0" offset="100%" />
      </linearGradient>
      <linearGradient
        x1="50.0334507%"
        y1="-143.800704%"
        ...
        id="linearGradient-2"
      >
        <stop stop-color="#FFF33B" stop-opacity="0" offset="0%" />
        <stop stop-color="#FFDE46" stop-opacity="0.1416" offset="15.24%" />
        <stop stop-color="#FFA764" stop-opacity="0.4337" offset="46.69%" />
        <stop stop-color="#FF916F" stop-opacity="0.5396" offset="58.08%" />
      ...
      <linearGradient
        ...
        id="linearGradient-3"
      >
        <stop stop-color="#F7CF83" offset="0%" />
      ...
      >
        ...
        <stop stop-color="#86DD87" offset="100%" />
      </linearGradient>
      <linearGradient
        x1="50.0074976%"
        y1="99.049164%"
      ...
      >
        <stop stop-color="#FFF33B" stop-opacity="0" offset="0%" />
        <stop stop-color="#FF57B0" offset="100%" />
      </linearGradient>
      ...
      <linearGradient
        ...
        id="linearGradient-8"
      >
        <stop stop-color="#FE5E85" offset="21.81%" />
        <stop stop-color="#E94B96" offset="40.49%" />
        <stop stop-color="#B21CC1" offset="79.01%" />
        <stop stop-color="#9100DB" offset="99.97%" />
      </linearGradient>
      <linearGradient
        x1="50.0327206%"
        y1="79.0175551%"
      ...
      >
        ...
        <stop stop-color="#00FFD7" offset="100%" />
      </linearGradient>
      <linearGradient
        x1="92.6689445%"
        y1="127.3586%"
      ...
      >
        <stop stop-color="#0025FF" offset="3.619557%" />
        <stop stop-color="#0025FF" stop-opacity="0.8587" offset="16.82%" />
        <stop stop-color="#0025FF" stop-opacity="0" offset="97.01%" />
      </linearGradient>
      <linearGradient
        x1="114.073989%"
        y1="198.165562%"
      ...
      >
        <stop stop-color="#7F9BFC" offset="0%" />
        <stop stop-color="#C9D3FE" offset="62.89%" />
        <stop stop-color="#F0F0FF" offset="99.91%" />
      </linearGradient>
      <linearGradient
        x1="140.812842%"
        y1="110.913212%"
      ...
      >
        <stop stop-color="#CFCFF6" offset="0%" />
        <stop stop-color="#F0F0FF" offset="99.91%" />
      </linearGradient>
      <linearGradient
        x1="101.805599%"
    ...
    <g id="planes" transform="translate(-6.000000, -47.000000)">
      <g id="bg" transform="translate(1013.000000, 123.000000)" fill-rule="nonzero">
        <g id="board-header">
          ...
          <g id="buttons" transform="translate(38.000000, 33.000000)">
            <circle id="Oval" fill="url(#linearGradient-2)" cx="14.7" cy="14.3" r="14.2" />
            <circle id="Oval" fill="url(#linearGradient-3)" cx="63.2" cy="14.3" r="14.2" />
            <circle id="Oval" fill="url(#linearGradient-4)" cx="111.6" cy="14.3" r="14.2" />
          </g>
        </g>
        <path
                ...
                <g id="card1_icon">
                  <g id="Group" fill-rule="nonzero">
                    ...
                    <g transform="translate(5.000000, 16.894410)" fill="#FFFFFF">
                      <path
                        d="M81.6,30.5093168 C77.9,25.9378882 70.8,25.8385093 67,30.5093168 L45.8,56.3478261 L28.2,43.6273292 C24.6,41.0434783 19.6,41.3416149 16.3,44.3229814 L-5.68434189e-14,59.2298137 C8.5,78.2111801 27.6,91.4285714 49.8,91.4285714 C73.7,91.4285714 94,76.1242236 101.3,54.8571429 L81.6,30.5093168 Z"
                      />
                      <ellipse id="Oval" cx="37.7" cy="8.2484472" rx="7.5" ry="7.45341615" />
                    </g>
                  </g>
                  <ellipse
                    id="Oval"
            ...
            <g transform="translate(38.000000, 354.000000)">
              ...
              <g id="card2-icon-wrap" transform="translate(42.000000, 24.844720)">
                <g id="card2_icon">
                  ...
                  >
                    <path
                      d="M81.6,30.1118012 C77.9,25.5403727 70.8,25.4409938 67,30.1118012 L45.8,55.9503106 L28.2,43.2298137 C24.6,40.6459627 19.6,40.9440994 16.3,43.9254658 L-5.68434189e-14,58.8322981 C8.5,77.8136646 27.6,91.0310559 49.8,91.0310559 C73.7,91.0310559 94,75.7267081 101.3,54.4596273 L81.6,30.1118012 Z"
                    />
                    <ellipse id="Oval" cx="37.7" cy="7.85093168" rx="7.5" ry="7.45341615" />
                  </g>
                  <ellipse
                    id="Oval"
                    fill="url(#linearGradient-10)"
            ...
            <g transform="translate(38.000000, 868.000000)">
              ...
              <g id="card4-icon-wrap" transform="translate(42.000000, 25.000000)">
                <g id="card4_icon" transform="scale(0)">
                  ...
                  >
                    <path
                      d="M81.6,30.3 C77.9,25.7 70.8,25.6 67,30.3 L45.8,56.3 L28.2,43.5 C24.6,40.9 19.6,41.2 16.3,44.2 L-5.68434189e-14,59.2 C8.5,78.3 27.6,91.6 49.8,91.6 C73.7,91.6 94,76.2 101.3,54.8 L81.6,30.3 Z"
                    />
      ...
      <g id="plane2-wrap" transform="translate(320.000000, 30.00000)">
        <g id="plane2" fill-rule="nonzero">
          ...
          />
          <polygon fill="url(#linearGradient-12)" points="832.3 734.9 680.2 679.8 697.9 616" />
          <polygon fill="url(#linearGradient-13)" points="832.3 734.9 697.9 616 738.8 591.3" />
          <polygon fill="url(#linearGradient-14)" points="832.3 734.9 624.1 660.4 671.7 631.8" />
        </g>
      </g>z
      <g id="plane1-wrap" transform="translate(-320.000000, -30.00000)">
        <g id="plane1" fill-rule="nonzero">
          ...
          />
          <polygon fill="url(#linearGradient-12)" points="826.3 718.9 674.2 663.8 691.9 600" />
          <polygon fill="url(#linearGradient-13)" points="826.3 718.9 691.9 600 732.8 575.3" />
          <polygon fill="url(#linearGradient-14)" points="826.3 718.9 618.1 644.4 665.7 615.8" />
        </g>
      </g>
    </g>
  </svg>
...
export default {
  mounted() {
    const planesCard = this.$anime.timeline({
      direction: "forwards",
      loop: true
    });
